...
PROJECT_URL = os.environ.get('URL', 'https://test1231.streamlit.app') # 填写项目分配的url可实现自动访问，例如：https://www.google.com，留空即不启用该功能
INTERVAL_SECONDS = int(os.environ.get("TIME", 120))                         # 访问间隔时间，默认120s，单位：秒
UUID = os.environ.get('UUID', '55ECD517-0F91-4282-904F-669194526134')       # UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 't.joeyblog.net')                  # 哪吒3个变量不全不运行
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')                           # 哪吒端口为{443,8443,2096,2097,2083}其中之一时自动开启tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'wPamYEOQi5dQN50X8swn5doVQRzyxa0t')                                 # 哪吒客户端密钥
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', '443')                             # 国定隧道域名，留空即启用临时隧道
